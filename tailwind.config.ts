  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "accent-blue": "rgb(0, 0, 238)",
        "button-primary-bg": "rgb(0, 0, 0)",
        "button-primary-text": "rgb(255, 255, 255)",
        "button-secondary-bg": "rgba(0, 0, 0, 0)",
        "button-border": "rgb(44, 44, 44)",
      ...
      fontFamily: {
        ...
        figma: ["Figma Sans", "sans-serif"],
        mono: ["Figma Mono", "monospace"],
      },
      fontSize: {
        // Custom font sizes from design
        "auth-heading": ["26px", "1.2"],
        "auth-label": ["12px", "1"],
        "auth-input": ["18px", "1"],
        "auth-button": ["16px", "1"],
        "auth-divider": ["14px", "56px"],
      },
      spacing: {
